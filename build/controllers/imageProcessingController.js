    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                resizedImagePath = "images/resized/".concat(filename, "x").concat(width, "x").concat(height, ".jpg");
                if (!!fs_1.default.existsSync(resizedImagePath)) return [3 /*break*/, 3];
                return [4 /*yield*/, (0, imageProcessingFunc_1.default)(filename, width, height)];
            case 1:
                resizedImage = _a.sent();
                return [4 /*yield*/, fs_1.promises.writeFile(resizedImagePath, resizedImage)];
            case 2:
                _a.sent();
                _a.label = 3;
            case 3:
